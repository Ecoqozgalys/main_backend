...
<?php
    ...
    if (isset($_GET['org_id'])) {
        ...
        // SELECT NAME FROM ORGANIZATIONS WHERE ORG_ID LIKE '$org_id';
        // or
        // SELECT * FROM ORGANIZATIONS WHERE ORG_ID LIKE '$org_id';
        ...
        // Altynai sql query
        // SELECT SALE FROM MATERIALS WHERE MATERIAL_TYPE LIKE '$type_of_materials';
