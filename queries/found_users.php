<?php
  ...
  $sql_query = $_SESSION['users_sql'];

  $found_users = oci_parse($db, $sql_query);
  oci_execute($found_users);
	...
	<center>
    	<section style = "margin-top: 100px">
    		<div class="brands-section">
    			<h5 class = "change" style="margin-bottom: 5vh;">Найденные пользователи</h5>
				...
				<?php
                    ...
                    while (($row = oci_fetch_array($found_users, OCI_ASSOC+OCI_RETURN_NULLS)) != false) {
                        echo "<tr>\n";
                        ...
                        // SELECT COUNT(user_id) FROM REQUEST WHERE USER_ID LIKE '$user_id';
