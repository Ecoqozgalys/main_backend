...
if (isset($_POST['reg_user'])) {
  ...
  //$user_check_query = "SELECT FIRST_NAME, EMAIL FROM USERS WHERE FIRST_NAME='$username' OR EMAIL='$email'";
  ...
  if (count($errors) == 0) {
    ...
    // Altynay here is sql_query
    // I've already created sequence, so it's enough to add 'DEFAULT' word instead of user_id
    // INSERT INTO USERS VALUES(default,'$username','$first_name','$last_name',$city,'$phone','$email','$password');
